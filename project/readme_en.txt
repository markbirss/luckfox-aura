...
1. If you see this "readme_en.txt" document, it means you have obtained the offline installation package of the LINUX IPC SDK and have extracted it to the current directory.

2. Please check whether there is a ".repo" folder in the current directory. If it exists, check out the code from the database using the following method:

####################################### command #######################################
	.repo/repo/repo sync -l
####################################### command #######################################

2.1 To get the first version of the SDK, it is recommended to synchronize the code again
		(if you haven't obtained online download permission yet, you can skip this step for the time being)
####################################### command #######################################
